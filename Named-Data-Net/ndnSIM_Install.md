...
2. ndnSIM 시작하기(참고 링크 : https://ndnsim.net/current/getting-started.html)
    ...
    (다운로드 완료된 리눅스 20.04)<br/>
    * 추가 : 간혹 리눅스 설치 직후 Terminal이 열리지 않는 경우가 있다. 이런 경우, 리눅스 내 'Setting'에 가서 Region & Language를 English(United State)가 아닌 다른 국가로 변경 후, Log Out & Log In을 진행하면 해당 문제를 해결할 수 있다.<br/>
